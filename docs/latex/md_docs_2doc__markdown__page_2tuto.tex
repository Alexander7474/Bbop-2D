\chapter{Tuto}
\hypertarget{md_docs_2doc__markdown__page_2tuto}{}\label{md_docs_2doc__markdown__page_2tuto}\index{Tuto@{Tuto}}
\label{md_docs_2doc__markdown__page_2tuto_autotoc_md0}%
\Hypertarget{md_docs_2doc__markdown__page_2tuto_autotoc_md0}%
...
\hypertarget{md_docs_2doc__markdown__page_2tuto_autotoc_md1}{}\doxysection{\texorpdfstring{Info}{Info}}\label{md_docs_2doc__markdown__page_2tuto_autotoc_md1}
Tous les getters de la librairie sont marqués comme const.\hypertarget{md_docs_2doc__markdown__page_2tuto_autotoc_md2}{}\doxysection{\texorpdfstring{Mise en place}{Mise en place}}\label{md_docs_2doc__markdown__page_2tuto_autotoc_md2}
...
\end{DoxyCode}
\hypertarget{md_docs_2doc__markdown__page_2tuto_autotoc_md3}{}\doxysection{\texorpdfstring{Forme géométrique / Shape}{Forme géométrique / Shape}}\label{md_docs_2doc__markdown__page_2tuto_autotoc_md3}
...
Toutes les \doxylink{classShape}{Shape} hérites de \doxylink{classBbopDrawable}{Bbop\+Drawable}, qui est la class mère de tous les objets dessinables de la librairie. ~\newline
 \hypertarget{md_docs_2doc__markdown__page_2tuto_autotoc_md4}{}\doxysubsection{\texorpdfstring{Rectangle / Rectangle\+Shape}{Rectangle / RectangleShape}}\label{md_docs_2doc__markdown__page_2tuto_autotoc_md4}
...
!!! AVANT TOUS AFFICHAGE IL FAUT SAVOIR UTILISER LA CLASS \doxylink{classScene}{Scene} !!! ~\newline
 \hypertarget{md_docs_2doc__markdown__page_2tuto_autotoc_md5}{}\doxysubsection{\texorpdfstring{Forme Convex / Convex\+Shape}{Forme Convex / ConvexShape}}\label{md_docs_2doc__markdown__page_2tuto_autotoc_md5}
todo\hypertarget{md_docs_2doc__markdown__page_2tuto_autotoc_md6}{}\doxysubsubsection{\texorpdfstring{Cercle / Circle\+Shape}{Cercle / CircleShape}}\label{md_docs_2doc__markdown__page_2tuto_autotoc_md6}
todo\hypertarget{md_docs_2doc__markdown__page_2tuto_autotoc_md7}{}\doxysubsubsection{\texorpdfstring{Et les triangles ?}{Et les triangles ?}}\label{md_docs_2doc__markdown__page_2tuto_autotoc_md7}
todo ~\newline
 \hypertarget{md_docs_2doc__markdown__page_2tuto_autotoc_md8}{}\doxysubsection{\texorpdfstring{Sprite}{Sprite}}\label{md_docs_2doc__markdown__page_2tuto_autotoc_md8}
...
\end{DoxyCode}
\hypertarget{md_docs_2doc__markdown__page_2tuto_autotoc_md9}{}\doxysubsubsection{\texorpdfstring{Sprite animé}{Sprite animé}}\label{md_docs_2doc__markdown__page_2tuto_autotoc_md9}
...
\end{DoxyCode}
\hypertarget{md_docs_2doc__markdown__page_2tuto_autotoc_md10}{}\doxysection{\texorpdfstring{Scene}{Scene}}\label{md_docs_2doc__markdown__page_2tuto_autotoc_md10}
...
\hypertarget{md_docs_2doc__markdown__page_2tuto_autotoc_md11}{}\doxysection{\texorpdfstring{Camera}{Camera}}\label{md_docs_2doc__markdown__page_2tuto_autotoc_md11}
...
\end{DoxyCode}
\hypertarget{md_docs_2doc__markdown__page_2tuto_autotoc_md12}{}\doxysection{\texorpdfstring{Collision}{Collision}}\label{md_docs_2doc__markdown__page_2tuto_autotoc_md12}
...
\end{DoxyCode}
\hypertarget{md_docs_2doc__markdown__page_2tuto_autotoc_md13}{}\doxysection{\texorpdfstring{Lumop}{Lumop}}\label{md_docs_2doc__markdown__page_2tuto_autotoc_md13}
Bbop2D intègre une gestion de la lumière (Lumop) ~\newline
 ...
 \hypertarget{md_docs_2doc__markdown__page_2tuto_autotoc_md14}{}\doxysubsection{\texorpdfstring{Light}{Light}}\label{md_docs_2doc__markdown__page_2tuto_autotoc_md14}
...
\hypertarget{md_docs_2doc__markdown__page_2tuto_autotoc_md15}{}\doxysubsection{\texorpdfstring{Light directionnel}{Light directionnel}}\label{md_docs_2doc__markdown__page_2tuto_autotoc_md15}
...
\end{DoxyCode}
\hypertarget{md_docs_2doc__markdown__page_2tuto_autotoc_md16}{}\doxysubsection{\texorpdfstring{Normal Map}{Normal Map}}\label{md_docs_2doc__markdown__page_2tuto_autotoc_md16}
...
La scene créé un deuxième frame buffer qui contient les normals maps à utiliser lors du rendue final de la lumière. ~\newline
 \hypertarget{md_docs_2doc__markdown__page_2tuto_autotoc_md17}{}\doxysection{\texorpdfstring{Map}{Map}}\label{md_docs_2doc__markdown__page_2tuto_autotoc_md17}
todo\hypertarget{md_docs_2doc__markdown__page_2tuto_autotoc_md18}{}\doxysection{\texorpdfstring{Math}{Math}}\label{md_docs_2doc__markdown__page_2tuto_autotoc_md18}
Bbop contient sa propre gestion des vecteurs.~\newline
 ...
 \hypertarget{md_docs_2doc__markdown__page_2tuto_autotoc_md19}{}\doxysection{\texorpdfstring{Texture}{Texture}}\label{md_docs_2doc__markdown__page_2tuto_autotoc_md19}
