...
class Scene
{
	...
	*/
	...
	std::vector<UniformLight>
		lightsVec; //<! Liste des lumières à transférer vers le shader avec lightUBO
	...
	unsigned int
		textureNormalMapBuffer; //<! texture de la normal map du buffer
	NoTextureSprite
		frameBufferSprite; //<! NoTextureSprite utilisé pour afficher le frame buffer
};
