...
class Shape : public BbopDrawable
{
	...
	*/
	Shape(GLfloat *vertices, GLsizeiptr verticesSize, GLuint *indices,
	...
	*/
	void initShape(GLfloat *vertices, GLsizeiptr verticesSize,
...
class RectangleShape : public Shape
{
	...
	*/
	...
	RectangleShape(Vector2f nSize, Vector2f nPos, Vector3i nRGB,
...
class ConvexShape : public Shape
{
	...
	*/
	...
	ConvexShape(int nnPoint, Vector2f *nlistPoint, Vector2f nSize,
		Vector2f nPos);
	ConvexShape(int nnPoint, Vector2f *nlistPoint, Vector2f nSize,
...
class CircleShape : public ConvexShape
{
	...
	*/
	...
	CircleShape(int nnPoint, float nRadius, Vector2f nSize, Vector2f nPos,
		Vector3i nRGB, Vector2f nOrigin);
	CircleShape(int nnPoint, float nRadius, Vector2f nSize, Vector2f nPos,
		Vector3i nRGB, Vector2f nOrigin, float nRotation, float nAlpha);
